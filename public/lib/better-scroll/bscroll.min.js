...
!(function(t, i) {
  ...
  function t(t) {
    return (
      !1 !== v &&
      ("standard" === v ? t : v + t.charAt(0).toUpperCase() + t.substr(1))
    );
  }
  function i(t, i, e, s) {
  ...
  function p(t, i, e, s, o, n) {
    var r = t - i,
      ...
      m = t + (h / a) * (r < 0 ? -1 : 1);
    return (
      c && l && (m = Math.round(m / l) * l),
      m < s
        ? ((m = o ? s - (o / d) * h : s), (u = p))
        : m > 0 && ((m = o ? (o / d) * h : 0), (u = p)),
      { destination: Math.round(m), duration: u }
    );
  }
  function c() {
  ...
  function d(t, i) {
    (this.wrapper = "string" === typeof t ? document.querySelector(t) : t),
      this.wrapper || u("can not resolve the wrapper dom"),
      (this.scroller = this.wrapper.children[0]),
      this.scroller ||
        u("the wrapper need at least one child element to be scroller"),
  ...
  return (
      ...
      (t.prototype._init = function(t, i) {
        ...
        (t.prototype._handleOptions = function(t) {
          (this.options = Object.assign({}, M, t)),
            ...
            (this.options.useTransition = this.options.useTransition && b),
        ...
        (t.prototype.refresh = function() {
          ...
          t
            ...
            (this.directionX = 0),
            (this.directionY = 0),
            (this.wrapperOffset = s(this.wrapper)),
    ...
    (function(t) {
      (t.prototype._start = function(t) {
        ...
        if (
          ...
          (this.initiated = i),
            this.options.preventDefault &&
              !n(t.target, this.options.preventDefaultException) &&
              t.preventDefault(),
            (this.moved = !1),
            (this.distX = 0),
            (this.distY = 0),
        ...
        (t.prototype._end = function(t) {
          if (
            ...
            if (this.moved) {
              ...
              if (
                this._events.flick &&
                l < this.options.flickLimitTime &&
                u < this.options.flickLimitDistance &&
                d < this.options.flickLimitDistance
              ) {
                this.trigger("flick");
              } else {
                var m = 0;
                if (
                  ...
                  l < this.options.momentumLimitTime &&
                  (d > this.options.momentumLimitDistance ||
                    u > this.options.momentumLimitDistance)
                ) {
                  var g = this.hasHorizontalScroll
                      ? p(
                          this.x,
                          this.startX,
                          l,
                  ...
                  (i = g.destination),
                    (e = f.destination),
                    (m = Math.max(g.duration, f.duration)),
                    (this.isInTransition = 1);
                } else {
                  this.options.wheel &&
                    ((e = Math.round(e / this.itemHeight) * this.itemHeight),
                    (m = this.options.wheel.adjustTime || 400));
                }
                var v = E.swipe;
                ...
                if (i !== this.x || e !== this.y) {
                  return (
                    (i > 0 ||
                      ...
                      e < this.maxScrollY) &&
                      (v = E.swipeBounce),
                    void this.scrollTo(i, e, m, v)
                  );
                }
                this.options.wheel &&
                  (this.selectedIndex = 0 | Math.abs(this.y / this.itemHeight)),
              ...
              if (this.options.wheel) {
                if (this.target && "wheel-scroll" === this.target.className) {
                  var w = Math.abs(Math.round(e / this.itemHeight)),
                    T = Math.round(
                      (this.pointY + s(this.target).top - this.itemHeight / 2) /
                        this.itemHeight
                    );
                ...
                this.options.tap && r(t, this.options.tap),
                  this.options.click && h(t);
              }
        ...
        (t.prototype._transitionTime = function() {
          ...
          if (
            ((this.scrollerStyle[S.transitionDuration] = t + "ms"),
            this.options.wheel)
          ) {
        ...
        (t.prototype._transitionTimingFunction = function(t) {
          if (
            ((this.scrollerStyle[S.transitionTimingFunction] = t),
            this.options.wheel)
          ) {
            for (var i = 0; i < this.items.length; i++)
        ...
        (t.prototype._animate = function(t, i, e, s) {
          function o() {
            ...
            if (p >= l) {
              return (
                ...
                void (
                  ...
                  n.trigger("scrollEnd", { x: n.x, y: n.y })
                )
              );
            }
            var u = s((p = (p - a) / e)),
            ...
            n._translate(d, m),
              n.isAnimating && P(o),
              3 === n.probeType &&
                n.trigger("scroll", { x: this.x, y: this.y });
          }
          var n = this,
            r = this.x,
            h = this.y,
              ...
              ? (this._transitionTimingFunction(s.style),
                ...
                this.options.wheel &&
                  (i > 0
                    ...
                    : (this.selectedIndex = 0 | Math.abs(i / this.itemHeight))))
          ...
          var t =
            ...
            i =
              arguments.length > 1 && void 0 !== arguments[1]
                ...
                : E.bounce,
            e = this.x;
          !this.hasHorizontalScroll || e > 0
            ? (e = 0)
            : e < this.maxScrollX && (e = this.maxScrollX);
          var s = this.y;
          return (
            !this.hasVerticalScroll || s > 0
              ? (s = 0)
        ...
        (t.prototype.getComputedPosition = function() {
          ...
          return (
            this.options.useTransform
              ? ((i = +(
                  (t = t[S.transform].split(")")[0].split(", "))[12] || t[4]
                )),
                (e = +(t[13] || t[5])))
    ...
    (function(t) {
      (t.prototype.on = function(t, i) {
        var e =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this;
    ...
    (function(t) {
      (t.prototype._initSnap = function() {
        ...
        if (i.loop) {
          ...
          e.length > 0 &&
            (a(e[e.length - 1].cloneNode(!0), this.scroller),
          ...
          this.on("refresh", function() {
            if (
              ...
              var e = i.stepX || t.wrapperWidth,
                ...
                m = void 0;
              if (s) {
                for (c = s.length, d = -1; p < c; p++)
                  {(m = o(s[p])),
                    (0 === p || m.left <= o(s[p - 1]).left) && ((u = 0), d++),
                    t.pages[u] || (t.pages[u] = []),
                    (r = Math.max(-m.left, t.maxScrollX)),
                    (h = Math.max(-m.top, t.maxScrollY)),
                    (a = r - Math.round(m.width / 2)),
                    (l = h - Math.round(m.height / 2)),
                    (t.pages[u][d] = {
                      x: r,
                      y: h,
                      width: m.width,
                ...
                for (
                  a = Math.round(e / 2), l = Math.round(n / 2);
                  r > -t.scrollerWidth;
              ...
              var f = i.threshold;
              f % 1 == 0
                ? ((t.snapThresholdX = f), (t.snapThresholdY = f))
                : ((t.snapThresholdX = Math.round(
                    t.pages[t.currentPage.pageX][t.currentPage.pageY].width * f
                  )),
                  (t.snapThresholdY = Math.round(
                    t.pages[t.currentPage.pageX][t.currentPage.pageY].height * f
                  )));
            }
          }),
          this.on("scrollEnd", function() {
            i.loop &&
              (0 === t.currentPage.pageX &&
                t.goToPage(t.pages.length - 2, t.currentPage.pageY, 0),
    ...
    (function(t) {
      (t.prototype.wheelTo = function(t) {
        this.options.wheel &&
          ((this.y = -t * this.itemHeight), this.scrollTo(0, this.y));
      }),
